# TODO: Контент для категорий

**Цель:** Создать/обновить content через `/content-generator`

---

## Как работать

1. Убедиться что есть RESEARCH_DATA.md (>2KB)
2. Запустить `/content-generator {slug}`
3. Проверить результат в `categories/{path}/content/{slug}_ru.md`
