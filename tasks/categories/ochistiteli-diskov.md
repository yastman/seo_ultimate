# ochistiteli-diskov — Ochistiteli Diskov

**Priority:** MEDIUM (volume 70)
**Type:** L3
...
### Create Structure
- [ ] `uk/categories/ochistiteli-diskov/data/`
- [ ] `uk/categories/ochistiteli-diskov/meta/`
- [ ] `uk/categories/ochistiteli-diskov/content/`
