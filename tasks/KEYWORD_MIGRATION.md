...
2. **Удалить** ключ из source JSON
3. **Обновить** stats.after в обоих файлах
4. **Валидировать** JSON: `python3 -c "import json; json.load(open('path'))"`
5. **Отметить** статус DONE в этом файле
