...
RULES = [
    ...
    {"pattern": "шампунь", "target": "avtoshampuni", "exclude_slugs": ["avtoshampuni", "kislotnyy-shampun", "s-voskom", "dlya-ruchnoy-moyki"]}, 
    {"pattern": "мойка авто", "target": "moyka-i-eksteryer", "exclude_slugs": ["moyka-i-eksteryer", "aktivnaya-pena", "dlya-ruchnoy-moyki", "nabory-dlya-moyki"]},
    {"pattern": "полировка", "target": "polirovka", "exclude_slugs": ["polirovka", "polirovalnye-pasty", "polirovalnye-krugi", "polirovalnye-mashinki"]},
    {"pattern": "для кожи", "target": "ukhod-za-kozhey", "exclude_slugs": ["ukhod-za-kozhey", "sredstva-dlya-kozhi", "chistka-kozhi"]}
]
...
def main():
    ...
    for issue in all_issues:
        print(f"| {issue['from_category']:<20} | {issue['keyword']:<40} | {issue['volume']:<6} | {issue['to_category']:<20} | {issue['reason']:<30} |")
