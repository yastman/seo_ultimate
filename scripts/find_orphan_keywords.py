...
KEYWORD_RULES = [
    ...
    # Двигатель
    (r'очистител.*двигател|мойк.*мотор|химия.*мотор|двигател.*очист|мойк.*двигател|средств.*двигател', 'ochistiteli-dvigatelya', 10),
    (r'химия.*(двигател|мотор)|(двигател|мотор).*химия|средств.*мот|мыт.*мотор', 'ochistiteli-dvigatelya', 10),
    ...
    (r'полирол.*пластик|пластик.*полирол|полирол.*торпед|торпед.*полирол', 'poliroli-dlya-plastika', 10),
