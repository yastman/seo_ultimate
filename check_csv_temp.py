...
csv_path = Path(r"c:\Users\user\Documents\Сайты\Ultimate.net.ua\сео_для_категорий_ультимейт\data\Структура  Ultimate финал - Лист2.csv")
                ...
                if col0.startswith('L3:'):
                    ...
                    if len(row) > 2:
                        ...
                        if vol and not vol.isdigit():
                            print(f"WARNING: Line {i+1} - Volume '{vol}' is not a digit for keyword '{col0}'")

        print(f"SUCCESS: CSV Read Completed")
