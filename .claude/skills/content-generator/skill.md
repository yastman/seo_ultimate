...
{Intro 30-50 слов: что + зачем + ключевой критерий выбора}
...
| Параметр | Hub Page | Buyer Guide |
|----------|----------|-------------|
| Объём | 400-600 слов | 800-1200 слов |
| Структура | Lead + Body + FAQ | Intro + Сценарии + Параметры + FAQ |
| Интент | Навигационный | Коммерческий |
| Принцип | Проблема → Решение (ссылка) | Детальный гид по выбору |
...
- Обновлены параметры Hub Pages (400-600 слов, структура Lead/Body/FAQ)
- Добавлен раздел "Hub Pages (краткий обзор)" для быстрой навигации
- Добавлен "Тест каждой секции" — выбор vs использование
- Добавлены явные блокеры (how-to, cross-sell, ошибки при работе)
