...
| Заголовок | Что должно быть | Пример |
|-----------|-----------------|--------|
| H1 | Primary keyword | "Автошампунь для ручной мойки" |
| H2 (минимум 1) | Primary или secondary | "Как выбрать шампунь для ручной мойки авто" |
| H3 | Secondary или supporting | "Место в двухфазной мойке" |
| FAQ вопросы | Secondary/supporting естественно | "Какой шампунь выбрать для авто с керамикой?" |

**Правило:** Не все H2/H3 обязаны содержать ключ, но минимум 1 H2 должен.
