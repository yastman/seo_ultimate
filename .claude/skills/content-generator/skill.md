...
```
1. Read data        → _clean.json (keywords, synonyms)
...
- [ ] **Профтермины из RESEARCH_DATA.md** (двухфазная мойка, лубриканты, etc.)
...
**Changelog v3.3:**
- **УБРАНЫ entities** — сгенерированные автоматически, не несут SEO-пользы
- Профтермины брать из **RESEARCH_DATA.md** (источник истины), не из `_clean.json`
- Обновлён Validation Checklist (E-E-A-T теперь ссылается на research)
