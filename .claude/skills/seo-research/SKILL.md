...
### 9. Совместимость (если применимо)
- С какими покрытиями совместим (воск, керамика, PPF, тонировка)
- Что снимает/ослабляет
- На каких материалах безопасен (хром, пластик, резина, кожа)

### 10. Типовые проблемы (troubleshooting)
- Почему "не работает" (жёсткая вода, пересушили, неправильная концентрация)
- Откуда разводы/пятна/липкость
- Как исправить
