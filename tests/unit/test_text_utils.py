...
def test_count_words_basic():
    ...
    from llm_keywords_pipeline.core.text import count_words
...
def test_count_chars_no_spaces():
    ...
    from llm_keywords_pipeline.core.text import count_chars_no_spaces
...
def test_tokenize_basic():
    ...
    from llm_keywords_pipeline.core.text import tokenize
