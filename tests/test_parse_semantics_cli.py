...
from parse_semantics_to_json import main, list_categories
...
class TestMain:
    ...
    def test_main_success_flow(self, mock_mkdir, mock_gen, mock_read, 
                             mock_semantics_data, mock_generated_json, capsys, tmp_path):
        ...
        with patch.object(sys, "argv", ["script.py", "aktivnaya-pena", "A"]):
