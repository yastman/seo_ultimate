...
def generate_plural_sql(
    mapping_file: Path = Path("data/opencart_mapping.json"),
    output_file: Path = Path("data/generated/plural_meta_update.sql"),
) -> list[str]:
    """Generate SQL statements for plural meta updates."""
