...
# Core imports from seo_ultimate
from seo_ultimate.core.config import CONTENT_STANDARDS, QUALITY_THRESHOLDS
from seo_ultimate.core.keywords import CoverageChecker, KeywordMatcher, keyword_matches_text
from seo_ultimate.core.seo import get_adaptive_requirements
...
def check_primary_keyword_semantic(
    text: str, primary_keyword: str, use_llm: bool = False, lang: str = "ru"
) -> dict:
    """
...
def validate_content(
    ...
    if semantic_allowed and (use_semantic or primary_kw["overall"] == "FAIL"):
        ...
        semantic_kw = check_primary_keyword_semantic(
            text, primary_keyword, use_llm=semantic_allowed, lang=lang
        )
