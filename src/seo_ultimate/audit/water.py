...
Usage:
    uv run python -m seo_ultimate.audit.water <file.md> [target_min] [target_max]
"""
...
from seo_ultimate.core.text import clean_markdown, get_stopwords
...
def main(argv: list[str] | None = None) -> int:
    ...
    if len(argv) < 1:
        print(
            "Usage: python -m seo_ultimate.audit.water <file.md> [target_min] [target_max] [--lang ru|uk]"
        )
        return 1
