...
Usage:
    uv run python -m seo_ultimate.audit.coverage --slug aktivnaya-pena --lang uk --verbose
    uv run python -m seo_ultimate.audit.coverage --lang uk  # batch all UK categories
    uv run python -m seo_ultimate.audit.coverage --slug X --lang uk --json
"""
...
from seo_ultimate.core.coverage import PreparedText, audit_category, check_keyword
