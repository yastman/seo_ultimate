...
Usage:
    uv run python -m seo_ultimate.audit.h1 --lang uk
    uv run python -m seo_ultimate.audit.h1 --lang ru
    uv run python -m seo_ultimate.audit.h1 --lang uk --json
    uv run python -m seo_ultimate.audit.h1 --lang uk --csv > reports/h1_audit_uk.csv
    uv run python -m seo_ultimate.audit.h1 --lang uk --slug aktivnaya-pena
"""
...
def validate_h1(h1: str, primary_keyword: str, lang: str = "ru") -> dict[str, Any]:
    ...
    if keyword_matches_text(primary_keyword, h1, lang=lang):
        result["passed"] = True
