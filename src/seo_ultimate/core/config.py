...
if _FILE_DIR.name == "core" and _FILE_DIR.parent.name == "seo_ultimate":
    # src/seo_ultimate/core/ → go up 3 levels to project root
    # core → seo_ultimate → src → seo-ultimate (project root)
